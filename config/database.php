...
return [
	...
	*/
	...
	'connections' => [
		...
		'galati' => [
			'driver' => env('DB_CONNECTION_GALATI'),
			'host' => env('DB_HOST_GALATI'),
			'port' => env('DB_PORT_GALATI'),
			'database' => env('DB_DATABASE_GALATI'),
		...
		'garantii' => [
			...
			'port' => env('DB_PORT_GARANTII'),
			'database' => env('DB_DATABASE_GARANTII'),
			'username' => env('DB_USERNAME_GARANTII'),
			'password' => env('DB_PASSWORD_GARANTII'),
		],
		'vapez' => [
			'driver' => env('DB_CONNECTION_VAPEZ'),
			'host' => env('DB_HOST_VAPEZ'),
			'port' => env('DB_PORT_VAPEZ'),
			'database' => env('DB_DATABASE_VAPEZ'),
