    ...
    <div class="container has-text-centered columns">
        <div class="column is-3 is-offset-2">
            ...
            <div class="box">
                <figure class="avatar">
                    ...
                    <div class="field">
                        <div class="control">
                            <input class="input is-large" v-model="admin.username" type="text" placeholder="Username" autofocus="">
                            <p class="help is-danger">{{erra.username}}</p>
                        </div>
                    </div>
                    <div class="field">
                        <div class="control">
                            <input class="input is-large" v-model="admin.parola" type="password" placeholder="Your Password">
        ...
        <div class="column is-3 is-offset-1">
            ...
            <div class="box">
                ...
                <div class="field">
                    <div class="control">
                        <input class="input is-large" v-model="user.username" type="text" placeholder="Username" autofocus="">
                        <p class="help is-danger">{{erru.username}}</p>
                    </div>
                </div>
                <div class="field">
                    <div class="control">
                        <input class="input is-large" v-model="user.nume" type="text" placeholder="Nume" autofocus="">
                        <p class="help is-danger">{{erru.nume}}</p>
                    </div>
                </div>
                <div class="field">
                    <div class="control">
                        <input class="input is-large" v-model="user.prenume" type="text" placeholder="Prenume" autofocus="">
                        <p class="help is-danger">{{erru.prenume}}</p>
                    </div>
                </div>
                <div class="field">
                    <div class="control">
                        <input class="input is-large" v-model="user.parola" type="password" placeholder="Your Password">
                        <p class="help is-danger">{{erru.parola}}</p>
                    </div>
                </div>
                <button class="button is-block is-info is-large is-fullwidth" @click="RegisterUser">Inregistrare</button>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        RegisterUser: function(event) {
            axios.post('/admin/createUser', { nume: this.user.nume, prenume: this.user.prenume, username: this.user.username, parola: this.user.parola }).then(response => {
                this.$emit('reg');
